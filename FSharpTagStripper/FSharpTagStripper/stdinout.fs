...
open System
    ...
    /// to any of the values in the 'chars' argument. If stdin is mapped to the console then you can use 13 as the <enter> key code so that the
    /// read sequence terminates when the user presses <enter>. If stdin is mapped to a file then you can use -1 as the code that corresponds
